    ...
    <section className="pt-16 md:pt-20 pb-12 md:pb-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto px-2">Партнерское объединение юридических лиц: размещайте свободные средства под Ключевую ставку + до 3,5% или получайте финансирование для бизнеса за 24 часа без банковской бюрократии</p>
