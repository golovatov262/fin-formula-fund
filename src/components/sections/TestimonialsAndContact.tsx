...
const faqItems = [
  ...
  {
    q: 'Какие членские взносы для юридических лиц и когда их платить?',
    a: 'Для ЮЛ и ИП членский взнос составляет 12 000 ₽ в год (или 1 000 ₽ в месяц) и уплачивается только со второго года членства в КПК. В первый год оплачиваются вступительный взнос (10 000 ₽) и возвратный паевой взнос (от 30 000 ₽). Членский взнос направляется на покрытие операционных расходов кооператива.'
  },
  {
