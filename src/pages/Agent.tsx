...
const steps = [
  ...
  },
  {
    ...
    desc: 'Рекомендуете КПК вашим клиентам-ЮЛ. Клиент вступает, оплачивает взносы. Вы получаете 5 000 ₽.',
    icon: 'BadgeRuble',
  },
];
...
const clientArgs = [
  ...
  { num: 4, title: 'Займ при блокировке ИФНС и ФССП', desc: 'Банк откажет. КПК выдаст и перечислит поставщику напрямую. Уникальный инструмент на рынке.' },
  ...
  { num: 6, title: 'Защита от блокировок ИФНС и ФССП', desc: 'Счёт пайщика не является банковским (ст. 845 ГК РФ). ИФНС и ФССП заблокировать его не вправе.' },
    ...
    <Layout>
      ...
      <section className="pt-28 pb-16 md:pt-36 md:pb-20 px-4 bg-gradient-to-b from-emerald-50 via-teal-50/30 to-transparent">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <MembershipForm
              source="Страница агентов — Hero кнопка"
      ...
      <section className="py-14 md:py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          ...
          <Card className="mt-8">
            <CardContent className="pt-5">
              <div className="text-center text-base font-bold text-primary uppercase tracking-wide mb-4">Условия вступления для клиента — ЮЛ</div>
